...
interface HeaderProps {
  ...
  currentPage: "home" | "category" | "post" | "login" | "editor" | "admin" | "privacidade";
  searchQuery: string;
  onNavigateHome: () => void;
  ...
  return (
    <header className="bg-[#0e1c2e] border-b border-slate-800 sticky top-0 z-50 shadow-sm font-sans">
      <div className="max-w-[1280px] mx-auto px-4 md:px-8">
        {/* Row 1: logo, search (centered), CTA */}
        ...
        {/* Row 2: horizontal category menu (desktop) */}
        <nav className="hidden lg:flex items-center gap-5 overflow-x-auto pb-4 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
