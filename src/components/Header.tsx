  ...
  return (
    <header className="bg-[#0e1c2e] border-b border-slate-800 sticky top-0 z-50 shadow-sm font-sans">
      <div className="max-w-[1280px] mx-auto px-4 md:px-8 h-20 flex justify-between items-center">
        ...
        {/* Search bar - fills the middle space on desktop */}
        ...
        {/* Início + Action Button CTA, grouped on the right */}
        <div className="hidden lg:flex items-center gap-6 shrink-0">
          <a
            ...
            className={`font-semibold text-sm transition-colors duration-200 pb-1 whitespace-nowrap ${
              currentPage === "home"
